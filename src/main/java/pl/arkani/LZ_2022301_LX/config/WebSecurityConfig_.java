...
////@Getter
//public class WebSecurityConfig_ {
//
//
//    @Bean
...
//
////    @Bean
////    JdbcUserDetailsManager user(DataSource dataSource, PasswordEncoder passwordEncoder,AuthenticationManagerBuilder auth) throws Exception {
////
//////        UserDetails user= (UserDetails) auth.userDetailsService(userDetailsService);
////
////        JdbcUserDetailsManager jdbcUserDetailsManager = new JdbcUserDetailsManager(dataSource);
////        jdbcUserDetailsManager.createUser(auth.userDetailsService(serDetailsService));
...
////
////    @Autowired
////    public void securityUsers(AuthenticationManagerBuilder auth,DataSource dataSource) throws Exception {
...
////                .authoritiesByUsernameQuery("select username,role from user where user_name=?").passwordEncoder(passwordEncoder())
////        ;
////
////    }
//
