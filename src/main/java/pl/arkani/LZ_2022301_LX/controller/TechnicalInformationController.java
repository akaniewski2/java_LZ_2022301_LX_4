...
public class TechnicalInformationController {
    ...
    public TechnicalInformationController(UserRepo userRepo, UserService userService, TokenRepo tokenRepo, TechPageRepo techPageRepo, SqlRepoExec sqlRepoExec, UserDetailsServiceImpl userDetailsService) {
    ...
    public String showHome(Model model, Principal principal) {
        ...
        return "_home/technicalinformation";
    }
}
